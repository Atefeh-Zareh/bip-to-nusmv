...
/* 365 */     PetriNet PN = (PetriNet)at.getBehavior();
/* 366 */     List<Transition> LnewT = new LinkedList<Transition>();
/* 367 */     EList eList = PN.getTransition();
/* 368 */     for (Object o : eList) {
/*     */       
/* 370 */       Transition T = (Transition)o;
/* 371 */       PortDefinitionReference pdr = (PortDefinitionReference)T.getTrigger();
/* 372 */       if (pdr.getTarget().getName().equals(PortName)) {
/*     */         
/* 374 */         Transition TT = (Transition)EcoreUtil.copy((EObject)T);
/* 375 */         TT.getDestination().addAll(new LinkedList((Collection<?>)T.getDestination()));
/* 376 */         TT.getOrigin().addAll(new LinkedList((Collection<?>)T.getOrigin()));
/* 377 */         LnewT.add(TT);
/*     */       } 
/*     */     } 
/* 380 */     return LnewT;
...
/* Location:              C:\D\Workspace\VeriSolid\My-Changes\smart-contracts-fixes-extensions\verificationTools\bip-to-nusmv.jar!\BIP2BIP\TConnectorType.class
