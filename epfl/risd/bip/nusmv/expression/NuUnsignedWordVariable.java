...
/*    */ 
/*    */ 
/*    */ public class NuUnsignedWordVariable
/*    */   extends NuVariable
/*    */ {
/*    */   private int size;
...
/* 13 */     this.type = NuEnumType.UNSIGNED_WORD;
/*    */   }
/*    */ 
/*    */   
/*    */   public NuUnsignedWordVariable(String n, int s, char not) {
/* 18 */     super(n, NuEnumType.UNSIGNED_WORD);
/* 19 */     this.size = s;
...
/* 25 */     super(n.name, NuEnumType.UNSIGNED_WORD);
/* 26 */     this.size = n.size;
